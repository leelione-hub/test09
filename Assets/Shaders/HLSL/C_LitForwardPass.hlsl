...
StructuredBuffer<float4x4> normalBuffer;
...
Varyings LitPassVertex(Attributes input)
{
    ...
    vertexInput.positionWS = worldPosition.xyz;
    vertexInput.positionVS = mul(GetWorldToViewMatrix(),worldPosition);
    vertexInput.positionCS = mul(GetWorldToHClipMatrix(),worldPosition);
