...
CBUFFER_START(UnityPerMaterial)
    ...
    half    _AdditionalLightDiffuseIntensity;
    half    _AdditionalLightSpecularIntensity;
    half    _AdditionalLightWrap;
    half    _AdditionalSpecularSmoothness;
    half    _AdditionalLightAffectsFace;
