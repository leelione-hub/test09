Shader "URP/VgSystem/M_Simple_Leaf"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/Shaders/HLSL/VgSystem/Leaf/M_Simple_LeafInput.hlsl"
            #include "Assets/Shaders/HLSL/VgSystem/Leaf/M_Simple_LeafForwardPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Assets/Shaders/HLSL/VgSystem/Leaf/M_Simple_LeafInput.hlsl"
            #include "Assets/Shaders/HLSL/VgSystem/Leaf/M_Simple_LeafDepthOnlyPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Assets/Shaders/HLSL/VgSystem/Leaf/M_Simple_LeafInput.hlsl"
            #include "Assets/Shaders/HLSL/VgSystem/Leaf/M_Simple_LeafDepthNormalsPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Assets/Shaders/HLSL/VgSystem/Leaf/M_Simple_LeafInput.hlsl"
            #include "Assets/Shaders/HLSL/VgSystem/Leaf/M_Simple_LeafShadowCasterPass.hlsl"
            ENDHLSL
        }
    }
