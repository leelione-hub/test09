Shader "URP/VgSystem/M_Simple_StandardLit"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Assets/Shaders/HLSL/VgSystem/StandardLit/M_Simple_StandardLitInput.hlsl"
            #include "Assets/Shaders/HLSL/VgSystem/StandardLit/M_Simple_StandardLitForwardPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include_with_pragmas "Packages/com.unity.render-pipelines.universal/ShaderLibrary/DOTS.hlsl"
            #include "Assets/Shaders/HLSL/VgSystem/StandardLit/M_Simple_StandardLitInput.hlsl"
            #include "Assets/Shaders/HLSL/VgSystem/StandardLit/M_Simple_StandardLitDepthOnlyPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include_with_pragmas "Packages/com.unity.render-pipelines.universal/ShaderLibrary/DOTS.hlsl"
            #include "Assets/Shaders/HLSL/VgSystem/StandardLit/M_Simple_StandardLitInput.hlsl"
            #include "Assets/Shaders/HLSL/VgSystem/StandardLit/M_Simple_StandardLitDepthNormalsPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include_with_pragmas "Packages/com.unity.render-pipelines.universal/ShaderLibrary/DOTS.hlsl"
            #include "Assets/Shaders/HLSL/VgSystem/StandardLit/M_Simple_StandardLitInput.hlsl"
            #include "Assets/Shaders/HLSL/VgSystem/StandardLit/M_Simple_StandardLitShadowCasterPass.hlsl"
            ENDHLSL
        }
    }
